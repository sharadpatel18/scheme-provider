      ...
      try {
        ...
        if (profileData) {
          ...
          setFormData(prev => ({
            ...prev,
            ...parsedProfile,
            // Keep the existing name and email if they exist
            firstName: prev.firstName || parsedProfile.firstName || '',
            middleName: prev.middleName || parsedProfile.middleName || '',
            lastName: prev.lastName || parsedProfile.lastName || '',
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 4 && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Preferred Communication Mode</label>
                  <select
            ...
            <div className="mt-8 flex justify-between">
              ...
              {step < 4 ? (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 ml-auto disabled:bg-blue-300"
                >
